...
document.querySelectorAll(".store-title").forEach((title) => {
  title.addEventListener("click", () => {
    const storeInfo = title.parentElement;

    // close others (accordion behavior)
    document.querySelectorAll(".storeInfo").forEach((item) => {
      if (item !== storeInfo) item.classList.remove("active");
    });
